...
const HeroSection = () => {
  const [refLeft, inViewLeft] = useInView({ triggerOnce: false, threshold: 0.2 });
  const [refRight, inViewRight] = useInView({ triggerOnce: false, threshold: 0.2 });
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-center md:justify-between w-full">
        ...
        >
          <h1 className="text-2xl md:text-6xl font-extrabold text-blue-900 leading-tight">
            नमस्ते 🙏🏻 , I am <br />
            <span className="text-blue-600 hover:text-yellow-600">Abishek Kr. Pandey</span>
          </h1>
          ...
          <a href="#contact">
            <button className="bg-blue-600 inline-block px-10 py-3 text-white font-semibold rounded-full shadow-md hover:bg-blue-700 transform transition-transform duration-200 hover:scale-110">
              Contact
            </button>
          </a>
        </motion.div>
